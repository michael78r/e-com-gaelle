  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Une erreur est survenue. Vous pouvez réessayer ou revenir au catalogue.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Whisly — boutique gourmande" },
      {
        ...
        content:
          "Chocolats, confitures, biscuits, boissons et produits d'épicerie. Commande par WhatsApp.",
      },
